package com.orange.physical.generator;
...
//        System.out.println(projectPath);
        ...
        */
        ...
        dsc.setUrl("jdbc:mysql://192.168.31.221:45017/football_gate?useUnicode=true&amp;characterEncoding=UTF-8&amp;autoReconnect=true&amp;useSSL=false&amp;zeroDateTimeBehavior=convertToNull&amp;allowMultiQueries=true");
        dsc.setUsername("orange");
        dsc.setPassword("orange");
...
//        pc.setModuleName(scanner("模块名"));//父包模块名,默认null
        ...
        pc.setParent("com.orange.physical");//默认com.baomidou
        ...
        //pc.setXml("*Mapper.xml");//默认mapper.xml
...
//                        + pc.getModuleName() + "/"
        ...
        //strategy.setSuperControllerClass("com.orange.physical.BaseController");
        //strategy.setSuperServiceClass();
        //strategy.setSuperServiceImplClass();
        //strategy.setSuperMapperClass("com.orange.physical.BaseMapper");
        //strategy.setSuperEntityClass("com.orange.physical.BaseEntity");//自定义继承的Entity类全称，带包名
